...
/**
 * HandshakeIcon
 * Represents authentic partnership and White-Glove Migration.
 * Uses Font Awesome Solid Handshake geometry with smooth greeting pump animation.
 */
export const HandshakeIcon: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      viewBox="0 0 640 640"
      fill={fill}
      className={`handshake-icon ${isHovered ? "is-hovered" : ""} ${className}`}
      {...props}
    >
      <style>{`
        .handshake-group {
        ...
        .handshake-icon:hover .handshake-group,
        .handshake-icon.is-hovered .handshake-group {
          animation: handshakePump 0.65s cubic-bezier(0.25, 1, 0.5, 1);
        }
        @keyframes handshakePump {
          0% {
