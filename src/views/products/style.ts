...
export const usestyles = createUseStyles((theme: Theme) => ({
  ...
  "@keyframes floatOrbCyan": {
    ...
    "33%": {
      transform: "translate(-28px, 24px) scale(0.95)",
    },
    "66%": {
  ...
  /* Tool Replacement Hero / Ticker Section - Light Theme Revamp */
  tickerSection: {
    position: "relative",
    width: "100%",
  ...
  tickerCard: {
    ...
    backgroundColor: "#FFFFFF",
    background:
      "radial-gradient(circle at 50% 30%, rgba(56, 189, 248, 0.08) 0%, rgba(248, 250, 252, 0.6) 50%, #FFFFFF 100%)",
    border: "1px solid rgba(226, 232, 240, 0.9)",
    boxShadow:
      "0 20px 45px -15px rgba(15, 23, 42, 0.07), 0 0 0 1px rgba(226, 232, 240, 0.5)",
    ...
    "&:hover": {
      borderColor: "#CBD5E1",
      boxShadow:
        "0 24px 50px -15px rgba(15, 23, 42, 0.1), 0 0 0 1px rgba(203, 213, 225, 0.6)",
    },
    "@media (max-width: 768px)": {
      padding: "32px 16px",
      borderRadius: "20px",
  ...
  tickerGradientText: {
    background: "linear-gradient(90deg, #0284C7 0%, #0070E8 50%, #4F46E5 100%)",
  ...
  tickerToolBadge: {
    ...
    "&::after": {
      ...
      height: "1px",
      background:
        "linear-gradient(90deg, transparent, rgba(148, 163, 184, 0.65), transparent)",
  ...
  tickerConvergenceArrow: {
    width: "14px",
    height: "14px",
    color: "#0284C7",
    flexShrink: 0,
  },
  weblingsBadgeWrapper: {
    position: "relative",
    display: "inline-flex",
    alignItems: "center",
    justifyContent: "center",
    ...
    "&:hover $weblingsBadge": {
      ...
      boxShadow:
        "0 14px 28px -4px rgba(2, 132, 199, 0.18), 0 2px 8px -2px rgba(2, 132, 199, 0.06)",
    },
  },
  weblingsBadgeGlow: {
    position: "absolute",
    ...
    borderRadius: "9999px",
    background:
      "linear-gradient(90deg, rgba(2, 132, 199, 0.35), rgba(79, 70, 229, 0.3))",
    opacity: 0.35,
    filter: "blur(6px)",
  ...
  weblingsBadge: {
    ...
    boxShadow:
      "0 10px 22px -4px rgba(2, 132, 199, 0.12), 0 2px 6px -1px rgba(0, 0, 0, 0.04)",
  ...
  aiNodePurple2: {
    ...
    backgroundColor: "rgba(147, 51, 234, 0.7)",
    boxShadow: "0 0 8px rgba(147, 51, 234, 0.6)",
    animation: "$nodeBlink 4s ease-in-out infinite 1.2s",
  },
  aiNodeCyan1: {
    bottom: "200px",
    right: "10%",
    ...
    animation: "$nodeBlink 3.6s ease-in-out infinite 0.6s",
  },
  aiNodeCyan2: {
    bottom: "340px",
    right: "5%",
    backgroundColor: "rgba(6, 182, 212, 0.7)",
    boxShadow: "0 0 8px rgba(6, 182, 212, 0.6)",
    animation: "$nodeBlink 4.4s ease-in-out infinite 2s",
  },
  aiSection: {
    position: "relative",
    zIndex: 1,
  ...
  aiCardPurple: {
    ...
    "&:hover": {
      ...
      boxShadow: "0 14px 30px -4px rgba(129, 51, 241, 0.2)",
  ...
  aiCardCyan: {
    ...
    "&:hover": {
      transform: "translateY(-4px)",
      boxShadow: "0 14px 30px -4px rgba(0, 114, 196, 0.2)",
